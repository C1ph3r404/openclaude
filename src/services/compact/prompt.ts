...
const NO_TOOLS_PREAMBLE = `<system-reminder>CRITICAL: Respond with TEXT ONLY. Do NOT call any tools.
...
const NO_TOOLS_TRAILER =
   ...
   'Tool calls will be rejected and you will fail the task.</system-reminder>'
